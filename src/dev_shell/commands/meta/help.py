...
class HelpCommand:
    ...
    HELP_TEXT = {
        ...
        "System Commands": {
            ...
            "memory": "Show RAM usage  [-s include swap]",
            "disk": "Show disk partitions  [-a all partitions]",
            "network": "Show network interfaces, IP, and I/O counters",
            "processes": "List processes by CPU  [-n N] [-a all]",
            "env": "Show environment variables  [KEY]",
